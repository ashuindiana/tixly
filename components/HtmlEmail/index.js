export function html({ url, host, email }) {
  ...
  return `
      ...
      <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to Tixly Account</h2>
      
      <h3 style="text-align: center; text-transform: uppercase;">${escapedHost}</h3>
      
      <p>Congratulations! You're almost set to start your trading journey.
